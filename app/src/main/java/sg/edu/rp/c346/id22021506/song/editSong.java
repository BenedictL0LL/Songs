...
public class editSong extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        year.setText(String.valueOf(rYear.getYearReleased()));
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                rTitle.setTitle(stTitle);
                rSingers.setSingers(stSingers);
                rYear.setYearReleased(iYear);
                rStars.setStars(starss);
                db.updateSong(rTitle);
                db.updateSong(rSingers);
                db.updateSong(rYear);
                db.updateSong(rStars);
                db.close();
                finish();
            }
        });
